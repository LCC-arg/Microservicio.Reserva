    ...
    public partial class MicroservicioReserva : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Alta", new DateTime(2023, 5, 6, 0, 0, 0, 0, DateTimeKind.Local), 4, 0, 2000, 0, 0 });

            migrationBuilder.InsertData(
                table: "Pago",
                columns: new[] { "PagoId", "Fecha", "MetodoPagoId", "Monto", "ReservaId" },
                values: new object[] { 1, new DateTime(2023, 5, 6, 0, 0, 0, 0, DateTimeKind.Local), 1, 2000, 1 });

            migrationBuilder.InsertData(
                table: "Factura",
                columns: new[] { "FacturaId", "Estado", "Fecha", "Monto", "PagoId" },
                values: new object[] { 1, "Pagada", new DateTime(2023, 5, 6, 0, 0, 0, 0, DateTimeKind.Local), 2000, 1 });
